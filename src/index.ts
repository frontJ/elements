...
export const area = createElement('area', { children: false })
...
export const base = createElement('base', { children: false })
...
export const br = createElement('br', { children: false })
...
export const col = createElement('col', { children: false })
...
export const embed = createElement('embed', { children: false })
...
export const hr = createElement('hr', { children: false })
export const html = createElement('html')
export const i = createElement('i')
export const iframe = createElement('iframe')
export const img = createElement('img', { children: false })
export const input = createElement('input', { children: false })
...
export const link = createElement('link', { children: false })
...
export const meta = createElement('meta', { children: false })
...
export const param = createElement('param', { children: false })
...
export const track = createElement('track', { children: false })
export const u = createElement('u')
export const ul = createElement('ul')
export const video = createElement('video')
export const wbr = createElement('wbr', { children: false })
